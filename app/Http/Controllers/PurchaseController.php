...
class PurchaseController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('purchase.create')
            ->with(compact('taxes', 'orderStatuses', 'business_locations', 'currency_details', 'default_purchase_status', 'customer_groups', 'types', 'shortcuts', 'payment_line', 'payment_types', 'accounts', 'bl_attributes', 'common_settings','default_datetime'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // $transaction_data['transaction_date'] = $this->productUtil->uf_date(now()->format('Y-m-d h:i:s'), true);
