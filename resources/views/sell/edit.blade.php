		        ...
		        <div class="clearfix"></div>
	                ...
	                <div class="form-group">
                              ...
                              <select class='form-control select2' name="city_id" id="city">
                                ...
                                <option {{$city->id==$city_area[0]->city_id?"selected":''}} value="{{$city->id}}">{{$city->name}}</option>
                                @endforeach
                              </select>
										</div>
							</div>
	                ...
	                <div class="form-group">
									<label>Area</label>
										<select class="form-control select2" name="area_id" id="area_select">
										<option value="">Select Area</option>
										@foreach($areas as $area)
                        <option {{$area->id==$city_area[0]->id?"selected":''}} value="{{$area->id}}">{{$area->area}}</option>
                    @endforeach
