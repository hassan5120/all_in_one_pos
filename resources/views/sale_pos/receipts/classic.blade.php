		...
		<table class="table table-responsive table-slim">
			<thead>
				<tr>
					...
					<th class="text-right" width="15%">Lot#</th>
					<th class="text-right" width="15%">Expiry</th>
					...
					<tr>
						<td>
                            ...
                            @endif
												...
												<td>@if(!empty($line['product_expiry'])), {{$line['product_expiry_label']}}:  {{$line['product_expiry']}} @endif</td>
						<td class="text-right">
