...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/cityArea', [CityAreaController::class, 'index'])->name('index.area');;
    Route::get('/area/create', [CityAreaController::class, 'create'])->name('create.area');
    Route::post('/area/store', [CityAreaController::class, 'store'])->name('store.area');
    Route::get('/area/destory/{id}', [CityAreaController::class, 'delete'])->name('destory.area');
    Route::get('/area/{city_id}', [CityAreaController::class, 'get_area'])->name('get.area');
